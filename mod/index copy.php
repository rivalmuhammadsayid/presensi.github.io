<?php
	...
	<html lang="id-ID" xml:lang="id-ID">
	    ...
	    <head>
	    	...
	    	<meta content="PT. Unibless Indo Multi" name="publisher"/>
	        	...
	        	<div class="container">
	        		<div class="row h-100 justify-content-center align-items-center">
	        			<div class="col-lg-5">
	        				...
	        				<p>
	        				<img src="<?php echo $site_url; ?>/content/logo/uimborder_big.png" class="img-fluid">
	        				</p>
			...
			<footer>
				<div class="container">
					...
					<div class="col-12 text-center">
						<p class="pt-4 pb-2">
						©2022 Copyright PT. Unibless Indo Multi. All Rights Reserved.
						</p>
					</div>
					</div>
				</div>
